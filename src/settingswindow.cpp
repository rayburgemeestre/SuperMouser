...
void SettingsWindow::CreateControls()
{
    ...
    // Generated by DialogBlocks, Mon 16 Dec 2013 11:04:43 CET (unregistered)
    ...
    itemStaticBoxSizer4->Add(itemBoxSizer32, 0, wxGROW|wxLEFT|wxRIGHT, 5);

    wxStaticText* itemStaticText33 = new wxStaticText( itemPanel2, wxID_STATIC, _("Undo key:"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer32->Add(itemStaticText33, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    textctrlKeyUndo = new wxTextCtrl( itemPanel2, ID_TEXTCTRL8, _("U"), wxDefaultPosition, wxDefaultSize, 0 );
    textctrlKeyUndo->SetMaxLength(1);
    itemBoxSizer32->Add(textctrlKeyUndo, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);
	...
	textctrlKeyUp->SetValue(wxString::Format(wxT("%c"), keyNavUp));
	textctrlKeyDown->SetValue(wxString::Format(wxT("%c"), keyNavDown));
	textctrlKeyLeft->SetValue(wxString::Format(wxT("%c"), keyNavLeft));
	textctrlKeyRight->SetValue(wxString::Format(wxT("%c"), keyNavRight));
	textctrlKeyUndo->SetValue(wxString::Format(wxT("%c"), keyNavUndo));

	textctrlMouseLeftClick->SetValue(wxString::Format(wxT("%c"), keyMouseSingleClick));
	textctrlMouseDoubleClick->SetValue(wxString::Format(wxT("%c"), keyMouseDoubleClick));
	textctrlMouseRight->SetValue(wxString::Format(wxT("%c"), keyMouseRightClick));
...
void SettingsWindow::UpdateShortcutKeys()
{
	...
	statusbar->SetStatusText(wxString::Format(wxT("%c"), s.c_str()), 0);
	statusbar->SetStatusText(wxString::Format(wxT("%c"), shortcutKey), 1);
...
#ifndef __WXMAC__
	textctrlControlKeys->SetValue(wxString(s.c_str(), wxConvUTF8));
#endif
}
